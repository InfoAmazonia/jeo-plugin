...
Each related point is stored as one entry of the `_related_point` metadata key. Each entry is an object with all the information retrieved by the geocoder or, when using AI georeferencing, by the AI model.
...
## AI-generated geolocation fields

When a point is generated by AI georeferencing (rather than manual geocoding), the `_related_point` entry includes an additional field:

- `_ai_quote` (string) — the excerpt from the post content that the AI identified as referencing this location.
...
'_related_point' => [
    'relevance' => 'primary',
    '_geocode_lat' => '-3.1303',
    '_geocode_lon' => '-60.0234',
    '_geocode_full_address' => 'Teatro Amazonas, Manaus, Amazonas, Brasil',
    '_geocode_country' => 'Brasil',
    '_geocode_country_code' => '',
    '_geocode_city' => 'Manaus',
    '_geocode_region_level_2' => 'Amazonas',
    '_geocode_region_level_3' => '',
    '_geocode_city_level_1' => '',
    '_ai_quote' => 'O Teatro Amazonas, localizado no centro de Manaus, reabriu após restauro.',
],
```
