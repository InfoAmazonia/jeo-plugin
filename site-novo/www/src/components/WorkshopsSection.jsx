          ...
          {WORKSHOPS.map((w, i) => (
            <Reveal key={w.n} delay={i * 0.1}>
              <motion.article
                ...
                className="group flex h-full flex-col rounded-2xl border border-brand/40 bg-gradient-to-b from-brand-darkest via-brand-darkest/30 to-base p-8 text-left shadow-card transition-colors duration-300 hover:border-brand/70"
              >
                ...
                <div className="mt-7 flex">
                  <a
                    href="#comunidade"
                    className="inline-flex w-full items-center justify-center rounded-lg border border-white/20 bg-ink/50 px-6 py-3.5 text-sm font-semibold text-slate-100 transition-all duration-300 hover:border-brand/70 hover:bg-brand hover:text-ink"
                  >
                    Inscrever-se
                  </a>
                </div>
