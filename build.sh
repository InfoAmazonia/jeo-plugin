...
# Remove a pasta vendor vazia do src se existir para evitar confusão
rm -rf $BUILD_DIR/$PLUGIN_SLUG/vendor
# Copia a pasta vendor real gerada pelo composer na raiz do projeto para a raiz do pacote zip
