...
class Discovery extends Component {
	...
	buildUrlParamsString( params, encodeParamsToURL = true, urlConcatString =  '/embed/?discovery=true') {
	...
	render() {
		...
		const buildURLParams = {
			'selected-layers': this.state.appliedLayers.map( ( layer ) =>  {
				if (layer.map) {
					return { id: layer.id, map: layer.map.id };
				}
		...
		const notEncodedUrl = this.buildUrlParamsString(buildURLParams, false, document.location.pathname + '?share=true');
		const shareStateUrl = this.buildUrlParamsString(buildURLParams, false, document.location.pathname + '?share=true')
					...
					{ ! this.props.embed && (
						...
						>
							<div className="options">
								<a href={ "https://twitter.com/intent/tweet?text=" + generatedEmbedUrl } target="_blank" rel="noreferrer">
								...
								<a href={ "https://www.facebook.com/sharer/sharer.php?u=" + generatedEmbedUrl }  target="_blank" rel="noreferrer">
								...
								<a href={ "mailto:?subject=Discovery&body=" + shareStateUrl }  target="_blank" rel="noreferrer">
