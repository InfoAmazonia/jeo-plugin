						...
						<nav className="layers-selection">
							<div className="layer-selection-title">
								<div className="legends-title">
									...
									{ this.state.layersWrapperDisplay == 'none' && (
										<div
											onClick={ () => {
												this.setState( { ...this.state, layersWrapperDisplay: 'block' } )
											} }
										>
											<img 
									...
									{ this.state.layersWrapperDisplay == 'block' && (
										<div 
											onClick={ () => {
												this.setState( { ...this.state, layersWrapperDisplay: 'none' } )
											} }
										>
											<img 
												alt="layers-selection-icon"
							...
							<div className="layers-wrapper" style={ { display: this.state.layersWrapperDisplay } }>
								{ this.props.navigateMapLayers.map(
									( layer ) => {
										const removeLayer = () => {
