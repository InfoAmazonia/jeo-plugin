...
class Storymap {
	...
	public function register_post_type() {
		$labels = array(
			...
			'name'                     => __( 'Story Map', 'jeowp' ),
			'singular_name'            => __( 'Story Map', 'jeowp' ),
			'add_new'                  => __( 'Add new Story Map', 'jeowp' ),
			'add_new_item'             => __( 'Add new Story Map', 'jeowp' ),
			'edit_item'                => __( 'Edit Story Map', 'jeowp' ),
			'new_item'                 => __( 'New Story Map', 'jeowp' ),
			'view_item'                => __( 'View Story Map', 'jeowp' ),
			'view_items'               => __( 'View Story Maps', 'jeowp' ),
			'search_items'             => __( 'Search Story Maps', 'jeowp' ),
			'not_found'                => __( 'No Story Map found', 'jeowp' ),
			'not_found_in_trash'       => __( 'No Story Map found in the trash', 'jeowp' ),
			'menu_name'                => __( 'Story Maps', 'jeowp' ),
			'item_published'           => __( 'Story Map published.', 'jeowp' ),
			'item_published_privately' => __( 'Story Map published privately.', 'jeowp' ),
			'item_reverted_to_draft'   => __( 'Story Map reverted to draft.', 'jeowp' ),
			'item_scheduled'           => __( 'Story Map scheduled.', 'jeowp' ),
			'item_updated'             => __( 'Story Map updated.', 'jeowp' ),
		);

		$args = array(
			'labels'              => $labels,
			'hierarchical'        => false,
			'description'         => __( 'JEO Story Map', 'jeowp' ),
