...
- description: Provide one paragraph (1-2 sentences) describing what the layer depicts, written in the user's language (e.g. "Camada com área do município de Manaus (AM)"). NEVER include disclaimers such as "Generated by AI", "simplified geometry", "approximation" or similar meta-commentary — describe only what is shown.
