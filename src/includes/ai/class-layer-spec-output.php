...
class Layer_Spec_Output {
	...
	/**
	 * Human-readable description of what the layer depicts.
	 *
	 * @var string
	 */
	#[SchemaProperty(
		description: 'One paragraph (1-2 sentences) describing what the layer shows, written in the user\'s language. Describe only what is depicted (e.g. "Layer with rivers in Brazil"). Never include disclaimers such as "Generated by AI", "simplified geometry" or "approximation".',
	)]
